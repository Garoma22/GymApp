...
//
  ...
  @Mapping(source = "trainee.user.username", target = "username")
  @Mapping(source = "trainee.user.firstName", target = "firstName")
  @Mapping(source = "trainee.user.lastName", target = "lastName")
  @Mapping(source = "trainee.dateOfBirth", target = "dateOfBirth")
  @Mapping(source = "trainee.address", target = "address")
  @Mapping(source = "trainee.user.active", target = "active")
