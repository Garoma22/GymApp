...
using the mapping defined in the TraineeMapperImplementationMethodAutogeneratedNoUsedInMyCode method
  ...
  @Mapping(source = "user.lastName", target = "lastName")
  @Mapping(source = "user.username", target = "username")
  TraineeDto3fields TraineeMapperImplementationMethodAutogeneratedNoUsedInMyCode(Trainee trainee);

  @IterableMapping(qualifiedByName = "toTraineeDtoWith3Fields")
  List<TraineeDto3fields> toTraineeDto3ListNew(List<Trainee> trainees);
