...
//    try {
//
//      System.out.println("Trainee id autogenerated: ok");
...
//
//      traineeService.createTrainee(null, firstName, lastName, dateOfBirth, address);
//
//      if (traineeService.createTrainee(null, firstName, lastName, dateOfBirth, address)) {
...
//    String trainingTypeName = scanner.nextLine();
//
//    // Проверка существует ли тип тренировки
//    trainingType = trainingTypeService.getTrainingTypeByName(trainingTypeName);
//
//    if (trainingType == null) {
//      // Если тип не найден, создаем новый и сохраняем его
//      trainingType = new TrainingType(trainingTypeName);
//      trainingTypeService.save(trainingType);
//      System.out.println("Created new Training Type: " + trainingTypeName);
//    }
//
//
//
